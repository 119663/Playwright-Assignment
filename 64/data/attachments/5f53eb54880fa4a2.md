...
- Location: tests/ui/products.spec.ts:71:5
...
Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    10 × unexpected value "Automation Exercise"
        ...
        - insertion [ref=e87]:
          - generic [ref=e90]:
            ...
            - link [ref=e93] [cursor=pointer]:
              - generic [ref=e94]: API documentation service
              - img [ref=e96]
            - link [ref=e98] [cursor=pointer]:
              - generic [ref=e99]: Test case management
              - img [ref=e101]
            - link [ref=e103] [cursor=pointer]:
              - generic [ref=e104]: Automation skills assessment
              - img [ref=e106]
            - link [ref=e108] [cursor=pointer]:
              - generic [ref=e109]: Beginner software testing
              - img [ref=e111]
            - link [ref=e113] [cursor=pointer]:
              - generic [ref=e114]: Internet & Telecom
              - img [ref=e116]
            - link [ref=e118] [cursor=pointer]:
              - generic [ref=e119]: Factory Automation
              - img [ref=e121]
...
```ts
  ...
  42 |     await viewProductAddToCart.addToCartButton.click();
  43 | })
  44 | 
  45 | 
  ...
  53 |     await addToCart.viewProductAddToCart.click();
  54 | })
  55 | 
  56 | test ("Add a product to cart and checkout", async ({page}) => {
  57 |     const products = new ProductsPage(page);
  58 |     await products.navigate();
  59 |     await expect(page).toHaveTitle('Automation Exercise');
  60 |     await products.productsButton.click();
  61 |     await expect(page).toHaveTitle('Automation Exercise - All Products');
  62 |     await products.addToCartButton.click();
  63 |     await page.locator("//div[contains(@class,'modal-content')]//a[@href='/view_cart']").click();
  64 |     await expect(page).toHaveTitle('Automation Exercise - Checkout');
  65 |     await products.checkoutButton.click();
  66 |     await expect(page).toHaveTitle('Automation Exercise - Checkout');
  67 |     await products.placeOrderButton.click();
  68 | 
  69 | })
  70 | 
  71 | test ("Delete a product from cart", async ({page}) => {
  72 |     const products = new ProductsPage(page);
  73 |     await products.navigate();
  74 |     await expect(page).toHaveTitle('Automation Exercise');
  75 |     await products.productsButton.click();
> 76 |     await expect(page).toHaveTitle('Automation Exercise - All Products');
     |                        ^ Error: expect(page).toHaveTitle(expected) failed
  ...
  93 |     await products.addToCartButton.click();
  94 |     await products.addquantityInput.fill('2');
  95 |     await products.viewProductAddToCart.click();
  96 | 
  97 | })
```