...
Locator: getByText('Logged in as Kenny')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Logged in as Kenny')
  ...
  - insertion [ref=e62]:
    - iframe [ref=e65]:
      - iframe [ref=f72e1]:
        - generic [ref=f75e2]:
          - iframe [ref=f75e5]:
            - generic [ref=f81e2] [cursor=pointer]:
              - generic:
                - img "Texturelabs_LensFX_137L 2"
              - generic:
                - img "1"
              - generic:
                - img "2"
